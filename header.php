...
<head>
  ...
  <link rel="icon" href="<?php bloginfo('stylesheet_directory'); ?>/img/dist/mp-icon.png">
  <link rel="shortcut" href="<?php bloginfo('stylesheet_directory'); ?>/img/dist/favicon.ico">
  <link rel="apple-touch-icon" href="<?php bloginfo('stylesheet_directory'); ?>/img/dist/mp-icon.png">
  <link rel="apple-touch-icon" sizes="114x114" href="<?php bloginfo('stylesheet_directory'); ?>/img/dist/mp-icon-114.png">
